 ...
 * 
 */
@WebServiceClient(name = "BankService", targetNamespace = "http://api.bank.training.pl/", wsdlLocation = "http://localhost:8080/bank/BankService/BankFacade?wsdl")
    ...
    extends Service
{
    ...
    private final static QName BANKSERVICE_QNAME = new QName("http://api.bank.training.pl/", "BankService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/bank/BankService/BankFacade?wsdl");
     ...
     *     returns Bank
     */
    @WebEndpoint(name = "Bank")
    public Bank getBank() {
        return super.getPort(new QName("http://api.bank.training.pl/", "Bank"), Bank.class);
    }
     ...
     */
    @WebEndpoint(name = "Bank")
    public Bank getBank(WebServiceFeature... features) {
        return super.getPort(new QName("http://api.bank.training.pl/", "Bank"), Bank.class, features);
    }
